...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/libgdx2d-games
...
git push --all -f https://github.com/sakib-rahman-bangladesh/libgdx2d-games